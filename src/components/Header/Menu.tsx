        ...
        <S.ContainerMenu>
            <S.ElementsMenu>
                <S.ContainerLogo>
                    ...
                    >
                        <S.Logo>MKS{" "} <S.SubtitleLogo>Sistemas</S.SubtitleLogo> </S.Logo>
                    </motion.div>
                </S.ContainerLogo>
                <S.ContainerCartMenu onClick={props.menu}>
                    ...
                    <S.NumbersItensOfCart>{props.cartItemCount}</S.NumbersItensOfCart>
                </S.ContainerCartMenu>
            </S.ElementsMenu>
        </S.ContainerMenu>
    )
